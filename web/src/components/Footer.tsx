...
export default function Footer() {
  return (
    <footer className="mt-16 border-t border-cyan-700/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="font-semibold text-cyan-700">Bulut Yarka Tavukculuk</div>
              <p className="text-sm opacity-80">Kaliteli & Sağlıklı Tavuklarımız ile tanışın.</p>
            </div>
          </div>
        </div>
        <div>
          <div className="font-semibold mb-2 text-cyan-700">Sayfalarımız</div>
        ...
        <div>
          <div className="font-semibold mb-2 text-cyan-700">İletişim</div>
          <ul className="space-y-1 text-sm">
            <li>
              <span className="text-cyan-700 font-semibold">Adres:</span> Meram / KONYA — Tarsus / MERSİN
              </li>
            <li>
              <span className="text-cyan-700 font-semibold">E-posta:</span> 
            ...
            <li>
              <div className="flex items-center gap-4 flex-wrap">
                <span><span className="text-cyan-700 font-semibold">Telefon:</span> 
                <a href="tel:05543125164"> 0554 312 51 64</a></span>
                <span><span className="text-cyan-700 font-semibold">WhatsApp:</span> 
      ...
      <div className="bg-cyan-700 text-white py-3">
