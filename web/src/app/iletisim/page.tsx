      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="mailto:bulutyarkatavukculuk@gmail.com" className="text-amber-800 hover:underline">bulutyarkatavukculuk@gmail.com</a>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <a href="tel:+905543125164" className="text-amber-800 hover:underline">+90 554 312 51 64</a>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="tel:+905515053607" className="text-amber-800 hover:underline">+90 551 505 36 07</a>
          </div>
        </div>
      </div>
    </div>
